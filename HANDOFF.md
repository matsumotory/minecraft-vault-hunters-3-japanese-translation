...
1. CurseForge投稿 (作者アカウントの登録と投稿の実行は本人。名前・スラッグ・説明文・ロゴ・jarは準備済み)。public切替の前に`--history`の全履歴検査をもう一度通す
2. 投稿後: リポジトリのpublic切替 (本人)、GitHub Releaseの作成、READMEの「未リリース」表記の除去
