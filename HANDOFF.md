...
- **3.21.7-ja.2の公開が完全に完了 (2026-08-17)**: GitHub Release (タグ+jar) とCurseForgeファイル (審査承認済み、Latest release掲載) を配布済み。インスタンス削除からの利用者手順E2Eで、アプリがja.2を自動で配ることと、2回起動後のハードコード層の日本語化を画面で確認した。Descriptionも本人がmarkdown構造版 (【】装飾廃止) へ差し替え、公開ページで見出し・手順・箇条書きの正しいレンダリングとja.2の掲載を確認済み。本人操作の残りは無い
